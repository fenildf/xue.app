(function(a) {
    function u(e, j) {
        ...
        function u(f, e, g, c) {
            ...
            a(".dww ul", t).each(function(g) {
                var x = a(this),
                    ...
                    j = g == e || void 0 === e;
                if (!b.hasClass("dw-v")) {
                    for (var h = b, i = 0, n = 0; h.prev().length && !h.hasClass("dw-v");) h = h.prev(), i++;
        ...
        function W() {
            ...
            if ("inline" != g.display) {
                var e =
                    ...
                    j = a(".dw", t),
                    k, h, i, n, m, o = {}, F, s = void 0 === g.anchor ? v : g.anchor,
                    c = c || a(window).height();
        ...
        k.changeWheel = function() {
            if (t) {
                var f = 0,
                    e, b, d, c = arguments.length;
                for (e in g.wheels)
                    for (b in g.wheels[e]) {
                        if (-1 <
                            a.inArray(f, arguments) && (T[f] = g.wheels[e][b], d = a("ul", t).eq(f), d.html(x(f)), c--, !c)) {
                            W();
                            u();
                            return
                        }
    ...
    var p = {}, i, C = function() {}, m, c, d, o, w = (new Date).getTime(),
        ...
        N = function() {
            var e = ["Webkit", "Moz", "O", "ms"],
                a;
            for (a in e)
                if (E([e[a] + "Transform"])) return "-" + e[a].toLowerCase();
            return ""
        }(),
        B = a.extend,
